...
URL_PATH_SIGNALS: dict[PageType, list[str]] = {
    ...
    PageType.GETTING_STARTED: [
        "/getting-started/", "/gettingstarted/", "/quickstart/", "/start/",
        "/installation/",
    ],
    PageType.FAQ: ["/faq/", "/faqs/"],
    PageType.RELEASE_NOTES: [
        "/release-notes/", "/releasenotes/", "/changelog/", "/releases/",
        "/whatsnew/", "/what-is-new/",
    ],
    PageType.TROUBLESHOOTING: [
        "/troubleshooting/", "/troubleshoot/", "/error/", "/errors/",
        "/common-issues/", "/common-problems/",
    ],
    PageType.MIGRATION: [
        "/migration/", "/migrating/", "/migrate/", "/upgrade/", "/upgrading/",
        "/porting/",
    ],
...
TITLE_KEYWORD_SIGNALS: dict[PageType, list[str]] = {
    ...
    PageType.GETTING_STARTED: [
        "getting started", "quickstart", "quick start", "installation",
        "first steps", "beginner",
    ],
    PageType.FAQ: ["faq", "frequently asked", "common questions"],
    PageType.RELEASE_NOTES: [
        "release notes", "changelog", "what's new", "whats new",
        "release", "version",
    ],
    PageType.TROUBLESHOOTING: [
    ...
    PageType.CONFIGURATION: [
        "configuration", "config", "settings", "setup", "environment",
        "parameters",
    ],
}
...
HEADING_PATTERN_SIGNALS: dict[PageType, list[str]] = {
    ...
    PageType.CONFIGURATION: [
        r"^configuration", r"^settings", r"^options", r"^parameters",
        r"^environment", r"^properties",
    ],
    PageType.EXAMPLES: [
        r"^example\b", r"^examples?\b", r"^sample\b",
        r"^usage\b", r"^demonstration",
    ],
}
