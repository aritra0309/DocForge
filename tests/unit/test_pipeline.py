...
class TestPipeline:
    ...
    async def test_run_full_success(  # ruff: ignore[PLR0914, PLR0917]
        self,
    ...
    @patch("docforge.core.pipeline.MetadataGenerator")
    @patch("docforge.core.pipeline.StorageEngine")
    async def test_run_full_with_specific_version(  # ruff: ignore[PLR0917]
        self,
        mock_store_cls: MagicMock,
        mock_meta_cls: MagicMock,
        mock_chunk_cls: MagicMock,
    ...
    @patch("docforge.core.pipeline.MetadataGenerator")
    @patch("docforge.core.pipeline.StorageEngine")
    async def test_page_error_skipped_pipeline_continues(  # ruff: ignore[PLR0917]
        self,
        mock_store_cls: MagicMock,
        mock_meta_cls: MagicMock,
        mock_chunk_cls: MagicMock,
